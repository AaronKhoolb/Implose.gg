...
Program Name: /actions/moderator/create_achievement.php
Description: Create new achievement from moderator panel
...
$redirect_url = '/Implose.gg-src/pages/moderator/create_achievement.php';
...
add_system_log($conn, $admin_id, 'Moderator Create Achievement', "Moderator created achievement #$new_id ($log_title).");
