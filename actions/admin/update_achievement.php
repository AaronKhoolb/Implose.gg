...
Program Name: /actions/admin/update_achievement.php
Description: Update an existing achievement from admin panel
...
$redirect_url = '/Implose.gg-src/pages/admin/edit_achievement.php?id=' . $id;
...
add_system_log($conn, $admin_id, 'Admin Update Achievement', "Admin updated achievement #$id ($log_title).");
