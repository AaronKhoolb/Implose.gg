...
Program Name: /pages/moderator/edit_achievement.php
Description: Moderator Edit Achievement Page
            - Load achievement by ?id= param
            - Edit title, description, badge image, points
            - Form submits to /actions/moderator/update_achievement.php
...
<head>
    ...
    <title>Edit Achievement — Implose.gg Moderator</title>
    ...
    <div class="admin-main-content">
        ...
        <div class="eu-card">
            ...
            <div class="eu-card-body">
                ...
                <form method="POST" action="/Implose.gg-src/actions/moderator/update_achievement.php" enctype="multipart/form-data">
