...
Program Name: /pages/moderator/create_achievement.php
Description: Moderator Create Achievement Page
            - Create a new achievement with title, description, badge image, points
            - Form submits to /actions/moderator/create_achievement.php
...
<head>
    ...
    <title>Create Achievement — Implose.gg Moderator</title>
    ...
    <div class="admin-main-content">
        ...
        <div class="eu-page-header">
            <div class="eu-page-header-left">
                <nav class="eu-breadcrumb" aria-label="Breadcrumb">
                    <a href="/Implose.gg-src/pages/moderator/achievement.php">Achievement Management</a>
                    <span class="sep">/</span>
        ...
        <div class="eu-card">
            ...
            <div class="eu-card-body">
                ...
                <form method="POST" action="/Implose.gg-src/actions/moderator/create_achievement.php" enctype="multipart/form-data">
                    ...
                    <div class="eu-footer-actions">
                        <a href="/Implose.gg-src/pages/moderator/achievement.php" class="btn-cancel">← Back to Achievements</a>
