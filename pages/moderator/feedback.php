...
Program Name: /pages/moderator/feedback.php
Description: Moderator Feedback Management Page
            - Stat cards (Total, Positive, Neutral, Negative)
            - Filter by emoji + search
            - Table of feedback with user, target (quiz/course), emoji, comment, date
...
<head>
    ...
    <title>Feedback Management — Implose.gg Moderator</title>
</head>


<body class="admin-body">
    <?php
        $current_page = 'moderator_feedback';
                ...
                <tbody id="fb-tbody">
                    ...
                    <?php } else { ?>
                        <?php foreach ($fb_rows as $row) {
                            // Pick the emoji character + label. Unknown rating -> "?"
                            ...
                            // Target label — prefer the quiz name, fall back to course
                            ...
                            // Email (NULL when the user is gone)
